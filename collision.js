...
function aabbRayCollision(aabbMin, aabbMax, rayStart, rayEnd)
{
	...
	// var tMin = (aabbMin[0] - rayStart[0]) / rDelta[0];
	// var tMax = (aabbMax[0] - rayStart[0]) / rDelta[0];
	...
	// var tyMin = (aabbMin[1] - rayStart[1]) / rDelta[1];
	// var tyMax = (aabbMax[1] - rayStart[1]) / rDelta[1];
	...
	// if (((tMin > tyMax) || (tyMin > tMax)) && isFinite(tMin) && isFinite(tyMax) && isFinite(tyMin) && isFinite(tMax))
	//  return false;
	...
	// var tzMin = (aabbMin[2] - rayStart[2]) / rDelta[2];
	// var tzMax = (aabbMax[2] - rayStart[2]) / rDelta[2];
	...
	// if (((tMin > tzMax) || (tzMin > tMax)) && isFinite(tMin) && isFinite(tzMax) && isFinite(tzMin) && isFinite(tMax))
	//  return false;
